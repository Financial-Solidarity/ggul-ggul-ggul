...
export const challengeHandlers = [
  http.get('/challenges/search', () => {
    return HttpResponse.json({ content: sampleData });
  }),

  http.post('/challenges/join', () => {
    return HttpResponse.json({
      challengeId: 'uuid',
      lobbyChattingRoomId: 'uuid',
    });
  }),

  http.post('/challenges/:challengeId/password', async ({ request }) => {
    // @ts-ignore
